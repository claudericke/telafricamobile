<div class="register-wrapper center" style="min-height: 300px;">
    <div class="twelve columns center">
        <h4><strong>SMS Gateway</strong> Login</h4>
    </div>
    <div class="login-wrapper center">
        <div class="twelve columns login-form">
            ...
            <div class="four columns margin5 center" >
                <input type="button" name="register" class="button-primaryloginRegister center greenBG white u-full-width " value="Register" onclick="window.location = '/users/register/'" />
