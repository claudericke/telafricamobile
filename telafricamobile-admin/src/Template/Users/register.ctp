...
<div class="register-wrapper center" style="min-height: 800px;">
	...
	<div class="twelve columns register-form">
		...
		<div class="twelve columns"><div class="spacer">&nbsp;</div></div>
		<div class="twelve columns">
			<?php echo $this->Form->input('mobilenumber',  array('label' => '', 'placeholder' => 'Mobile Number', 'class' => 'mobileInput u-full-width')); ?>
		</div>
		<div class="twelve columns"><div class="spacer">&nbsp;</div></div>
		...
		<?php 
			...
			echo $this->Form->input('country', array('class' => 'u-full-width', 'label' => '',
            	'options' => array(
            		"" => "Select a country",
                    "AF" => "Afghanistan",
                    "AL" => "Albania",
