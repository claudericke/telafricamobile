<html xmlns="http://www.w3.org/1999/xhtml"><head>
      ...
      <style type="text/css">
         ...
         body{width:100% !important; -webkit-text-size-adjust:100%; -ms-text-size-adjust:100%; margin:0; padding:0;background: #F6F4F5;}
         ...
         td[class="logo"]{padding:10px 0 5px 0!important;margin: 0 auto !important; text-align: center;}
               ...
               <table width="580" bgcolor="#fff" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" hlitebg="edit" shadow="edit">
                  <tbody>
                     <tr>
                        <td>
                           <!-- logo -->
                           <table width="280" cellpadding="0" cellspacing="0" border="0" align="left" class="devicewidth" align="center">
                              <tbody>
                                 <tr>
                                    <td valign="middle" width="270" style="padding: 10px 0 10px 20px;" class="logo" >
                                       <div class="imgpop">
                                          <a href="http://www.telafricamobile.com/telafricamobile-admin/"><img src="http://www.telafricamobile.com/img/logo_color.png" alt="logo" border="0" style="display:block; border:none; outline:none; text-decoration:none;" st-image="edit" class="logo"></a>
                                       </div>
                                    </td>
                                 </tr>
                              </tbody>
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #95a5a6; text-align:left;line-height: 24px;" st-content="rightimage-paragraph">
                                      <!-- You have successfully registered to To Your Office. Your login details are as follows:<br/><br/>
                                       <strong>E-Mail Address: </strong><span></span><br/>
                                       <strong>Password: </strong><span></span><br/>-->
                                       <?= $value ?>
                                       <?= $value2 ?>
                                    </td>
                                 </tr>
                                 ...
                                 <tr>
                                    <td width="100%" height="20"><?= $value4 ?></td>
                                 </tr>
                                 <!-- /button -->
                                 <!-- Spacing -->
                                 <tr>
