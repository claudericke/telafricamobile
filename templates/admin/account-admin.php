        ...
        <div class="container">
            <div class="twelve columns panel">
                ...
                <table class="u-full-width sentMessages">
                            ...
                            <tbody>
                                <tr>
                                    <td title="example1@gmail.com" class="accountName">example1@gmail.com</td>
                                    <td>Administrator</td>
                                    <td>186</td>
                                   <td><button class="btn-primary u-full-width greenBG white center addCredit">Add Credits</button></td>
                                    ...
                                    <td><button class="btn-primary u-full-width redBG white center">Delete User</button></td>
                                </tr>
                                <tr>
                                    <td title="example2@gmail.com" class="accountName">example2@gmail.com</td>
                                    <td>Sales</td>
                                    <td>0</td>
                                   <td><button class="btn-primary u-full-width greenBG white center addCredit">Add Credits</button></td>
                                    <td><button class="btn-primary u-full-width blueBG white center">Remove Credits</button></td>
                                ...
                                <tr>
                                    <td title="example3@gmail.com" class="accountName">example3@gmail.com</td>
                                    <td>Registered</td>
                                    <td>-45</td>
                                   <td><button class="btn-primary u-full-width greenBG white center addCredit">Add Credits</button></td>
                                    <td><button class="btn-primary u-full-width blueBG white center">Remove Credits</button></td>
